...
fn binary_logical_expression_spans_correctly() {
    ...
    execute_program_expect_error(program, "Type mismatch: variable x is i32 but expression is bool");
}
...
fn binary_arithmetic_expression_spans_correctly() {
    ...
    execute_program_expect_error(program, "Type mismatch: variable x is bool but expression is int");
}
...
fn complex_nested_expression_spans_correctly() {
    ...
    "#;
    execute_program_expect_error(program, "Type mismatch: variable x is string but expression is bool");
}
...
fn function_call_spans_correctly() {
    ...
    "#;
    execute_program_expect_error(program, "Type mismatch: variable x is bool but expression is i32");
}
